<?php
	...
	#Make List
	//Trinity House
	$trinityHouseLighthouses = mysql_query('SELECT * FROM `Lighthouses` WHERE PageType="scotlandNLB" ORDER BY Name ASC') or die(mysql_error());
	...
	while($i < $numberOfTrinityHouseLighthouses) {
		...
		$lightURL = 'http://www.worldwidelighthouses.com/Lighthouses/Scottish-Lighthouses/Norhtern-Lighthouse-Board-Owned/'.$hyphenName;
	...
	//Privately Owned
	$privateLighthouses = mysql_query('SELECT * FROM `Lighthouses` WHERE PageType="scotlandprivate" ORDER BY Name ASC');
	...
	while($i < $numberOfPrivateLighthouses) {
		...
		$lightURL = 'http://www.worldwidelighthouses.com/Lighthouses/Scottish-Lighthouses/Privately-Owned/'.$hyphenName;
	...
	$content = '
		<h2 class="goldTitle">Scottish Lighthouses</h2>
		<div class="goldTextbox"><p>Scotlands main lighthouse authority is the Northern Lighthouse Board, you can see their lighthouses in Gold. Privately owned scottish lighthouses are in blue.</p></div>
		<h2 class="goldTitle">Northern Lighthouse Board Lighthouses</h2>
		<div class="goldTextbox"><ul class="gallery">'.$trinityHouseLighthousesHTML.'</ul></div>
		...
		$pageCode = '<!DOCTYPE HTML>
					<html lang="en-GB">
						<head>	
							...
							<title>Scottish Lighthouses | Worldwide Lighthouses</title>
						</head>
						<body>
							<header> 
