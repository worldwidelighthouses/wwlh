<?php
	...
	$content = '
		<h2 class="redTitle">Lightships</h2>
		<div class="redTextbox">
			<p>Select the country for which you are interested in looking at lightships from. Alternatively you could use the search function in the header to find a specific lighthouse</p>
			<ul class="gallery">
				<li>
		...
		$pageCode = '<!DOCTYPE HTML>
					<html lang="en-GB">
						<head>	
							...
							<meta name="keywords" content="Lighthouses,Daymarks,Trinity House,Fog Signals,Fog Horns,Fresnel">
							<meta name="description" content="Worldwide Lighthouses is the number 1 source of information, pictures and	 videos on the Subject of Lighthouses and Daymarks">
							<meta name="viewport" content="width=320; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;">
							<link rel="stylesheet" href="../resources/css/mobilePageLayout.css">
							<title>Lightships | Worldwide Lighthouses</title>
						</head>
						<body>
							<header> 
